...
var url = "https://randomuser.me/api/?gender=male&nat=fr&results=1000";
var tableTitles = ["First Name", "Last Name", "Age", "City"]; //create graph
...
function drawGraph(data) {
  ...
  var canvasElemt = document.getElementById("chart");
  var config = {
    type: "bar",
    data: {
  ...
  var menChart = new Chart(canvasElemt, config);
}
...
function getTableData(data) {
  var sortAge = data.results.sort(function (a, b) {
...
var loaderDiv = document.querySelector("#placeholder");
...
var imgDiv = document.getElementById("secondParDiv");
...
function _downloadData() {
  _downloadData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(apiUrl) {
    var response, data;
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            data = _context3.sent;
            dataGraph = getGraphData(data);
            drawGraph(dataGraph);
            dataTable = getTableData(data);
